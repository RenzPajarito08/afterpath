  ...
  const handleSave = async () => {
    ...
    try {
        ...
        const { error } = await supabase.from('journeys').insert({
            ...
            start_time: new Date(coordinates[0]?.timestamp || Date.now()).toISOString(),
  ...
  return (
    ...
    >
        ...
        <View style={styles.mapContainer}>
            ...
            >
                <Polyline coordinates={coordinates} strokeColor="#48BB78" strokeWidth={4} />
            </MapView>
            <View style={styles.overlayStats}>
                <Text style={styles.overlayText}>{(distance / 1000).toFixed(2)} km • {Math.floor(duration / 60)}m</Text>
            </View>
        </View>

        <Text style={styles.prompt}>"What stayed with you from this journey?"</Text>
        ...
        <TouchableOpacity style={styles.discardButton} onPress={() => navigation.navigate('MainTabs', { screen: 'HomeTab' })}>
